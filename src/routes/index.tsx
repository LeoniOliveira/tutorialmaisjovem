        ...
        <section className="section section-light" aria-labelledby="problem-title">
          <div className="container problem-container">
            <h2 id="problem-title" className="problem-headline">
              Existe um erro silencioso que faz a maquiagem envelhecer e acabar com a pele madura.{" "}
              <span className="problem-headline-accent"> E você está cometendo TODOS os dias…</span>
            </h2>
...
/* AUTHORITY */
.authority{display:grid;grid-template-columns:1fr 1.5fr;gap:64px;align-items:center;max-width:1100px;margin:0 auto}
.alice-photo-wrap{position:relative;width:100%;max-width:420px;aspect-ratio:1/1;margin:0 auto;justify-self:center}
.alice-photo{width:100%;height:100%;border-radius:50%;object-fit:cover;
  box-shadow:0 12px 40px rgba(0,0,0,.15);border:6px solid #fff}
.alice-badge{position:absolute;bottom:12px;left:50%;transform:translateX(-50%);
  background:var(--rosa-primario);color:#fff;font-weight:700;font-size:14px;
  padding:10px 20px;border-radius:999px;white-space:nowrap;box-shadow:0 4px 12px rgba(0,0,0,.2)}
.authority-text p{margin:0 0 18px;font-size:17px;line-height:1.65;color:var(--cinza-texto)}
