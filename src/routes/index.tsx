...
/* AUTHORITY */
.authority{display:grid;grid-template-columns:minmax(420px,1fr) 2fr;gap:80px;align-items:center;max-width:1180px;margin:0 auto}
.alice-photo-wrap{position:relative;width:100%;max-width:480px;aspect-ratio:1/1;margin:0 auto}
...
.authority-text p{margin:0 0 18px;font-size:18px;line-height:1.65;color:var(--cinza-texto)}
